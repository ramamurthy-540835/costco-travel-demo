...
gcloud services enable run.googleapis.com aiplatform.googleapis.com firestore.googleapis.com storage.googleapis.com iamcredentials.googleapis.com --project $PROJECT_ID
