...
| 4 | Booking & Rate Integrity (UC1, UC2, UC3) | 04-00, 04-01, 04-02, 04-03, 04-04, 04-05, 04-06, 04-07, 04-08, 04-09, 04-10, 04-11, 04-12 | In progress | - |
...
*Last updated: 2026-08-31 — 04-11 applied and unified (vehicle-card enrichment + supplier filter). 04-12 (checkout enrichment + extras toggles + rate-integrity extension) now in APPLY, per user's explicit "go ahead and APPLY" instruction covering both plans in sequence.*
